...
DESCRIPTION: str = 'Posts from the astronomy community on Bluesky. Managed by @emily.space. Signup: https://signup.astronomy.blue'

# (Optional) The path to an image to be used as your feed's avatar
# Ex: ./path/to/avatar.jpeg
AVATAR_PATH: str = './images/avatar.jpg'
