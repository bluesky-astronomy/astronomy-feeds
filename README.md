...
Some of the environment variables are now created with a dot-env file. Currently, they are only used in the astrofeed_server.
Make a copy of the file .env_template in the root, and fill in the details.
